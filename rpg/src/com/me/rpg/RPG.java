...
public class RPG implements Screen
{
	...
	public void dispose()
	{
		...
		manager.dispose();
		map.dispose();
		// TODO not sure what else we need to dispose of. Maybe all textures,
		// texture regions?
		// --> Anything that implements Disposable needs to call dispose() here
		// -Mark
	}
	...
	public void render(float delta)
	{
		...
		// render map
		map.render(batch, (int) camera.viewportWidth,
