...
public class RagnarokState extends ResettingHierarchicalState {

	private static final long serialVersionUID = -1154327234021551882L;

	public RagnarokState(HierarchicalState parent, GameCharacter character) {
		super(parent, character);
		
		//character.setRandomAttacker();
		character.setAttackerPlayer();
