...
public class DeadCharacter {
	...
	public DeadCharacter(GameCharacter deceased, Sprite gravestone, float fadeTime) {
		this.deceased = deceased;
		this.gravestone = gravestone;
		this.fadeTime = fadeTime;
		passedTime = 0f;
		this.gravestone.setPosition(deceased.getBottomLeftX(), deceased.getBottomLeftY());
	}
